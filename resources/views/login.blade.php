...
@section('content')
    <div class="panel panel-body login-form">
        ...
        <div class="text-center">
            <!--<div class="icon-object border-slate-300 text-slate-300"><i class="icon-reading"></i><img src="{{asset('public/images/512.svg')}}"></div>-->
            <img style="width: 50%;"  src="{{asset('public/images/512.svg')}}">
        </div>
